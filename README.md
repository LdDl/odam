...
ODaM is project aimed to do monitoring such as: pedestrian detection and counting, vehicle detection and counting, speed estivation of objects, sending detected objects to gRPC server for detailed analysis.
